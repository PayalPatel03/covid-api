# covid-api
The site https://covid-api-flame.vercel.app/ is a frontend app that fetches COVID-19 data, likely from an external API. However, it does not provide its own documentation or public API directly on the site.
